...
add_shortcode('gallery', 'boatdealer_parse_gallery_shortcode');
function boatdealer_parse_gallery_shortcode($atts)
{
    wp_register_script('flexslider', BOATDEALERPLUGINURL .
