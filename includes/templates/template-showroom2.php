...
$ctd = 0;
    ...
    while ($wp_query->have_posts()):
        ...
        /*
        $output .= ($miles != '' ? sprintf(
             translators: %s: Label for miles/km 
            esc_attr__( '%s: %s', 'boatdealer' ),
            esc_attr__( $miles_label, 'boatdealer' ),
            esc_attr( $miles )
        ) : '');
        */
...
wp_reset_query();
if ($qposts < 1) {
    $output .= '<br /><h4>' . esc_attr__('Not Found !','boatdealer') . '</h4>';
}
