...
class SettingsFactory {
	...
	public function add_settings_fields()
	{
		...
		*/
		...
		foreach($this->fields as $field) {
			if ($field->name === 'boatdealer_recipient') {
				register_setting($this->section->page_key, $field->name, array($this, 'sanitize_boatdealer_fieldfeatures'));
			} else {
				// register_setting($this->section->page_key, $field->name);
				register_setting($this->section->page_key, $field->name, array($field, 'sanitize'));
			}
			add_settings_field(
				$field->name,
	...
	public function sanitize_boatdealer_fieldfeatures($value)
	{
		// Sanitize the value of the 'cardealer_fieldfeatures' field here
		return wpboatdealer_strip_tags($value);
	}
